      ...
      const mockListings: MarketplaceListing[] = [
        {
          ...
          description: "Premium residential complex in the heart of Manhattan with high rental yields and excellent location.",
          image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&h=600&fit=crop",
          price: "125000000000000000", // 0.125 ETH in Wei (example)
          amount: 1000,
        ...
        },
        {
          ...
          description: "High-grade invoice financing opportunity from established tech company with 30-day terms.",
        ...
        },
        {
          ...
          description: "Physical gold bullion stored in Swiss vaults with full insurance and quarterly audits.",
        ...
        {
          tokenId: "1004",
          name: "S&P 500 ETF Shares",
          description: "Diversified equity portfolio tracking the S&P 500 index with professional management.",
          ...
          attributes: [
            ...
            { trait_type: "Symbol", value: "SPY" },
            { trait_type: "Exchange", value: "NYSE" },
            { trait_type: "Sector", value: "Diversified" }
          ]
        },
        {
          tokenId: "1005",
          name: "Carbon Credit Portfolio",
          description: "Verified carbon offset credits from renewable energy projects with strong environmental impact.",
          image: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=600&fit=crop",
          price: "95000000000000000", // 0.095 ETH in Wei
          amount: 1500,
          ...
          attributes: [
            ...
            { trait_type: "Project Type", value: "Wind Energy" },
            { trait_type: "CO2 Offset", value: "1000 tons" }
          ]
        }
      ];
      
      setListings(mockListings);
      console.log('✅ Mock marketplace listings loaded:', mockListings.length);
...
const ProfessionalListingsGrid: React.FC<{ 
  ...
  onSelectListing: (listing: MarketplaceListing) => void;
  tokenPrice: number;
}> = ({ listings, category, onSelectListing, tokenPrice }) => {
